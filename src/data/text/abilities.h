...
static const u8 sRunAwayDescription[] = _("Ups defenses at half HP.");
static const u8 sKeenEyeDescription[] = _("No Acc loss/Ignore Evasion.");
static const u8 sHyperCutterDescription[] = _("No Atk loss/Buffs Vicegrip.");
