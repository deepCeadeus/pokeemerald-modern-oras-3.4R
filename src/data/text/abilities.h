...
static const u8 sLightningRodDescription[] = _("Ups Electr moves in a pinch.");
...
static const u8 sEarlyBirdDescription[] = _("Wakes quickly & SLP heals.");
static const u8 sFlameBodyDescription[] = _("Burns the foe on contact.");
static const u8 sRunAwayDescription[] = _("Boosts Speed at half HP.");
static const u8 sKeenEyeDescription[] = _("No Acc down & Hits evasive.");
static const u8 sHyperCutterDescription[] = _("No Atk down & Ups Vice Grip.");
...
static const u8 sMultitypeDescription[] = _("Change type with items.");
static const u8 sPixilateDescription[] = _("Normal moves become Fairy.");
static const u8 sAdaptabilityDescription[] = _("Boosts STAB moves.");
...
static const u8 sSuperLuckDescription[] = _("Ups critical hit chance.");
static const u8 sDragonizeDescription[] = _("Normal moves become Dragon.");
static const u8 sMindsEyeDescription[] = _("Normal moves become Ghost.");
static const u8 sAerilateDescription[] = _("Normal moves become Flying.");
static const u8 sRivalryDescription[] = _("Ups damage to same gender.");
...
static const u8 sSkillLinkDescription[] = _("Moves hit max amount.");
